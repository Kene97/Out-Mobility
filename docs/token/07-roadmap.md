...
real activity. We are building the real activity first.

---

> *All timelines are directional, not contractual. Phases will be updated
> as milestones are reached. Community will be notified via @OutMobility
...
The work happening right now. This phase is about building the infrastructure
before the token can exist meaningfully.
...
Out-door network live with at least 50 active vehicles and verified
impression data flowing consistently.

---

## Phase 1 — Community Build (Upcoming)

**Status: Pre-launch**

Before the token launches, the community that will hold and use it needs
to exist. This phase is about building that community deliberately.

**Objectives:**
- Grow @OutMobility to an engaged, informed community
- Launch a token-specific information hub and newsletter
- Onboard early ecosystem partners (fleet operators, advertisers, carbon buyers)
- Complete smart contract audit
- Finalise and lock tokenomics
- Announce TGE parameters to waitlist members

**Milestone to exit this phase:**
Smart contract audited. Tokenomics locked. Community ready. Launch date set.
...
With the token live, the focus shifts to deepening its integration across
...
## Phase 4 — Utility Rollout

**Status: Future**

The network is running. The token is being used. This phase is about deepening
...
**Network progress.** If Out-door scales faster than expected, earlier phases
compress and the token can launch sooner. If it takes longer, the timeline
extends accordingly.

**Ecosystem conditions.** Regulatory, market, and technical conditions in
the crypto and mobility space can affect timing. We will communicate changes
