...
contribute to it, and align the interests of everyone involved.

---

## Why Does It Exist?

Out Mobility is building infrastructure across multiple layers of the mobility
stack: in-car advertising (Out-door), ride-hailing (Out-side), carbon offsetting
(Out-leaf), and EV charging (Out-charge).

Each of these products creates value. Each one generates transactions. Each one
...
**Problem 1: Fragmented incentives**

Today, a driver who runs ads on Out-door earns a revenue share in cash.
...
## How Does It Fit Into Out Mobility?
...
| TGE Date | Coming soon |

> All figures marked *proposed* are subject to change before the Token
> Generation Event (TGE). See [Tokenomics](03-tokenomics.md) for full detail.

---

*Next: [Token Utility →](02-utility.md)*
