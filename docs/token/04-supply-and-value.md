...
This is not a price prediction. It is an explanation of design intent.
...
This matters because inflationary token models — where new tokens are constantly
issued — dilute the value of existing holders. Out Mobility has chosen a fixed
supply model because it is simpler, more honest, and more aligned with a
long-term value narrative.

As the network grows and more of the circulating supply is staked, locked in
liquidity, or used in active transactions, the freely available supply naturally
tightens. Demand does the rest.

---

## Gradual Release, Not Flood
...
- **25% of supply** (community & rewards) flows slowly based on real network
  activity — not on a fixed calendar
- Only **15% of supply** (liquidity + public distribution) is fully unlocked
  at TGE

This means the market is not flooded on day one. Supply enters circulation
as the network earns it.

---

## Burn Mechanics (Planned)

> *This section describes planned burn mechanics. These are design proposals,
> not confirmed features. They will be finalised before TGE.*

Out Mobility plans to implement a **transaction-based burn mechanism** tied
to network activity.
...
supply. It is to create a steady, predictable reduction in circulating supply
that is directly proportional to how much the network is being used.

More activity → more burns → less circulating supply → natural scarcity.

The specifics of the burn rate will be confirmed before TGE.
...
**3. Steady burn**
Each transaction removes a small fraction from circulation permanently.
Over hundreds of millions of transactions, this compounds meaningfully.

**4. Staking lock-up**
Active ecosystem participants stake their tokens. The more active the ecosystem,
...
This logic only holds if the Out Mobility network actually grows.

If the network does not achieve meaningful scale, the demand side of the
...
*Next: [Liquidity & Launch Readiness →](05-liquidity-and-launch.md)*
