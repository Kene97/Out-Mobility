...
const phases = [
  ...
  },
  {
    ...
    items: [
      ...
      "Driver & operator $OUTSIDE payouts start",
  ...
  },
  {
    ...
    status: "future",
    items: [
      "$OUTSIDE-denominated ad payments (Out-door)",
      "Out-side launch with rider rewards",
      "Out-leaf pilot: first carbon credits in $OUTSIDE",
      "$OUTSIDE staking for advertisers activated",
  ...
  },
  {
    ...
    items: [
      ...
      "Out-charge: EV charging settled in $OUTSIDE",
